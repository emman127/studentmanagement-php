...
<meta name="theme-color" content="#563d7c">
  ...
  <div class="collapse navbar-collapse nav-space" id="navbarsExampleDefault">
    ...
    <li class="nav-item active">
      ...
      <!-- <li class="nav-item active dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Subject</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="addSubject.php">Add Subject</a>
          <a class="dropdown-item" href="#">View Subject</a>
        </div>
      </li> -->
      <!-- <li class="nav-item active dropdown">
        <a class="nav-link dropdown-toggle" href="addCourse.php" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Course</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
      ...
      <!-- </li>  -->
      <li class="nav-item active">
        <a class="nav-link" href="addSubject.php">Subject<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="addCourse.php">Course<span class="sr-only">(current)</span></a>
      </li>
    </ul>
